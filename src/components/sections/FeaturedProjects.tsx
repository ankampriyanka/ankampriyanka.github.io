...
export default function FeaturedProjects() {
  ...
  return (
    <section id="projects" className="bg-[#050505] py-24">
      <Container>
        <SectionHeading title="Selected Projects" subtitle="Applied systems and research prototypes focused on Responsible AI, AI Safety, governance and technical innovation." />
